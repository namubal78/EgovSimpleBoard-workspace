            ...
            <form id="enrollForm" method="post" action="insert.sub" enctype="multipart/form-data">
                ...
                <table align="center">
                    <tr>
                        ...
                        <td><input type="text" id="title" class="form-control" name="subBoardTitle" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea id="content" class="form-control" rows="10" style="resize:none;" name="subBoardContent" required></textarea></td>
                    </tr>
                </table>
                <br>
